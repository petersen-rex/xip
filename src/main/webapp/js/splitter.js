...
;(function($){
	$.fn.splitter = function(args){
		...
		return this.each(function() {
			...
			v:{ // Vertical
			moving:"left",sizing: "width", eventPos: "pageX",splitbarClass:"splitbarV",buttonClass: "splitbutton", cursor: "col-resize"
			},
			h: { // Horizontal 
			moving:"top",sizing: "height", eventPos: "pageY",splitbarClass:"splitbarH",buttonClass: "splitbutton",  cursor: "row-resize"
			}
			}[direction], args);
			...
			var perc;
			if(opts.initSize!=undefined){
				perc = opts.initSize;
			} else {
				perc=(((C.position()[opts.moving]-splitter.offset()[opts.moving])/splitter[opts.sizing]())*100).toFixed(1);
			}
